...
nombreExcel = "VIABILIDADES2.xlsx"
...
id_vars = df_final.iloc[:, :21].columns
value_vars = df_final.iloc[:,21:-1].columns
...
"""
df_melted.to_excel("result.xlsx", index=False)
print("DataFrame guardado exitosamente como:","result.xlsx")
