...
# =============================================================================
dfTipoEquipos =  pd.read_excel('tipoEquipos.xlsx', index_col="cod")
...
servidor = "lc2"
#servidor = input("Servidor para realizar la descarga:\n(lc1 / lc2): ")
...
#Menu de Tipo equipo
print("-----Menu Tipo Equipo------")
for i in dfTipoEquipos.index:
    print (str(dfTipoEquipos["cod"][i]),"-",str(dfTipoEquipos["nombre"][i]))
print("")
...
# if opcion == 749:
#     print ("749 - TRANSFORMADOR_MAT_AE")
#     prefijo = "749_"
#     tipoEquipo = "TX_MAT_AE"
# elif opcion == 750:
#     print ("750 - APOYO MT - LEV")
#     prefijo = "750_"
#     tipoEquipo = "AP MT - LEV"
# elif opcion == 3:
#     print("Opcion 3")
# elif opcion == 4:
#     salir = True
...
# df = pd.read_excel('descargaSoportesFtp.xlsx') # SE CARGA EL ARCHIVO EXCEL QUE ESTA DENTRO DE LA CARPETA
