...
df = pd.read_excel('descargaXmat.xlsx') # SE CARGA EL ARCHIVO EXCEL QUE ESTA DENTRO DE LA CARPETA
df_informe = pd.read_excel('Informe Tranformadores MLU.xlsx')

df = df.merge(df_informe[["PLACA MT COLOCADA","Equipo Ruta Id","Equipo Ruta Id padre","TERRITORIO","SUBESTACIÓN","CIRCUITO", "Nombre Ruta"]])
